...
import com.quata.documentreader.xs.fc.hslf.record.ColorSchemeAtom;
import com.quata.documentreader.xs.fc.hslf.record.Comment2000;
...
public final class Slide extends Sheet
{
     ...
     */
    public Slide(com.quata.documentreader.xs.fc.hslf.record.Slide slide, Notes notes, SlideAtomsSet atomSet,
    ...
    */
    ...
    {
        super(new com.quata.documentreader.xs.fc.hslf.record.Slide(), sheetNumber);
        _slideNo = slideNumber;
    ...
    * @see com.quata.documentreader.xs.fc.hslf.usermodel.SlideShow#reorderSlide(int, int)
    */
     ...
     */
    public com.quata.documentreader.xs.fc.hslf.record.Slide getSlideRecord()
    {
        return (com.quata.documentreader.xs.fc.hslf.record.Slide)getSheetContainer();
    }
