...
import   com.quata.documentreader.xs.fc.POIDocument;
import   com.quata.documentreader.xs.fc.codec.DigestUtils;
import   com.quata.documentreader.xs.fc.ddf.EscherBSERecord;
import   com.quata.documentreader.xs.fc.ddf.EscherBitmapBlip;
import   com.quata.documentreader.xs.fc.ddf.EscherBlipRecord;
import   com.quata.documentreader.xs.fc.ddf.EscherRecord;
import   com.quata.documentreader.xs.fc.hssf.OldExcelFormatException;
import   com.quata.documentreader.xs.fc.hssf.formula.FormulaShifter;
import   com.quata.documentreader.xs.fc.hssf.formula.SheetNameFormatter;
import   com.quata.documentreader.xs.fc.hssf.formula.ptg.Area3DPtg;
import   com.quata.documentreader.xs.fc.hssf.formula.ptg.MemFuncPtg;
import   com.quata.documentreader.xs.fc.hssf.formula.ptg.Ptg;
import   com.quata.documentreader.xs.fc.hssf.formula.ptg.UnionPtg;
import   com.quata.documentreader.xs.fc.hssf.formula.udf.AggregatingUDFFinder;
import   com.quata.documentreader.xs.fc.hssf.formula.udf.UDFFinder;
import   com.quata.documentreader.xs.fc.hssf.model.DrawingManager2;
...
import   com.quata.documentreader.xs.fc.hssf.model.RecordStream;
import   com.quata.documentreader.xs.fc.hssf.record.AbstractEscherHolderRecord;
...
import   com.quata.documentreader.xs.fc.hssf.record.EmbeddedObjectRefSubRecord;
...
import   com.quata.documentreader.xs.fc.hssf.record.LabelRecord;
import   com.quata.documentreader.xs.fc.hssf.record.LabelSSTRecord;
...
import   com.quata.documentreader.xs.fc.hssf.record.RecordFactory;
import   com.quata.documentreader.xs.fc.hssf.record.SSTRecord;
import   com.quata.documentreader.xs.fc.hssf.record.SubRecord;
...
import   com.quata.documentreader.xs.fc.hssf.util.CellReference;
import   com.quata.documentreader.xs.fc.poifs.filesystem.DirectoryNode;
import   com.quata.documentreader.xs.fc.poifs.filesystem.POIFSFileSystem;
import   com.quata.documentreader.xs.fc.ss.usermodel.IRow.MissingCellPolicy;
import   com.quata.documentreader.xs.fc.ss.util.WorkbookUtil;
 ...
 */
public final class HSSFWorkbook extends POIDocument implements   com.quata.documentreader.xs.fc.ss.usermodel.Workbook
{
...
//            names.add(name);
    ...
    /**
      ...
      * @see   com.quata.documentreader.xs.fc.hssf.record.LabelRecord
      * @see   com.quata.documentreader.xs.fc.hssf.record.LabelSSTRecord
      * @see   com.quata.documentreader.xs.fc.hssf.record.SSTRecord
      */
     ...
     * @see   com.quata.documentreader.xs.fc.hssf.usermodel.HSSFSheet#setSelected(boolean)
     */
     ...
     * @see {@link   com.quata.documentreader.xs.fc.ss.util.WorkbookUtil#createSafeSheetName(String nameProposal)}
     ...
     */
    public int getSheetIndex(  com.quata.documentreader.xs.fc.ss.usermodel.Sheet sheet)
    {
...
//        return newName;
     ...
     * @see   com.quata.documentreader.xs.fc.hssf.record.FormatRecord
     * @see   com.quata.documentreader.xs.fc.hssf.record.Record
     */
