...
import   com.quata.documentreader.xs.fc.hpsf.DocumentSummaryInformation;
import   com.quata.documentreader.xs.fc.hpsf.MutablePropertySet;
import   com.quata.documentreader.xs.fc.hpsf.PropertySet;
import   com.quata.documentreader.xs.fc.hpsf.PropertySetFactory;
import   com.quata.documentreader.xs.fc.hpsf.SummaryInformation;
...
import   com.quata.documentreader.xs.fc.poifs.filesystem.DocumentInputStream;
import   com.quata.documentreader.xs.fc.poifs.filesystem.Entry;
import   com.quata.documentreader.xs.fc.poifs.filesystem.NPOIFSFileSystem;
...
import   com.quata.documentreader.xs.fc.util.POIUtils;
...
public abstract class POIDocument
{
    ...
    protected PropertySet getPropertySet(String setName)
    {
        ...
        catch(  com.quata.documentreader.xs.fc.hpsf.HPSFException he)
        {
            // Oh well, doesn't exist
            logger.log(POILogger.WARN, "Error creating property set with name " + setName + "\n"
                + he);
        ...
        throws IOException
    {
        ...
        catch(  com.quata.documentreader.xs.fc.hpsf.WritingNotSupportedException wnse)
        {
