...
import com.quata.documentreader.xs.fc.doc.TXTKit;
import com.quata.documentreader.xs.fc.pdf.PDFLib;
import com.quata.documentreader.xs.pg.control.PGControl;
...
public class MainControl extends AbstractControl {
    ...
    public boolean openFile(String filePath) {
        ...
        if (lowerCase.endsWith(MainConstant.FILE_TYPE_DOC) || lowerCase.endsWith(MainConstant.FILE_TYPE_DOCX) || lowerCase.endsWith(MainConstant.FILE_TYPE_TXT)) {
