 ...
 * @author Yegor Kozlov
 */
public final class ShapeTypes implements com.quata.documentreader.xs.common.shape.ShapeTypes
{
    /**
    ...
    static
    {
        ...
        try
        {
            Field[] f = com.quata.documentreader.xs.common.shape.ShapeTypes.class.getFields();
