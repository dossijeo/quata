...
import com.quata.documentreader.xs.fc.ss.usermodel.IFont;
 ...
 * @see com.quata.documentreader.xs.fc.hssf.usermodel.HSSFCell#setCellStyle(HSSFCellStyle)
 */
public final class HSSFCellStyle implements ICellStyle {
     ...
     * @see com.quata.documentreader.xs.fc.hssf.usermodel.HSSFDataFormat
     */
     ...
     * @return the format string or "General" if not found
     */
    public String getDataFormatString(com.quata.documentreader.xs.fc.ss.usermodel.Workbook workbook) {
     ...
     * @see com.quata.documentreader.xs.fc.hssf.usermodel.HSSFDataFormat
     */
    public String getDataFormatString(com.quata.documentreader.xs.fc.hssf.model.InternalWorkbook workbook)
    {
...
//        return format.getFormat(getDataFormat());
     ...
     * @see com.quata.documentreader.xs.fc.hssf.usermodel.HSSFWorkbook#createFont()
     * @see com.quata.documentreader.xs.fc.hssf.usermodel.HSSFWorkbook#getFontAt(short)
     */
     ...
     * @see com.quata.documentreader.xs.fc.hssf.usermodel.HSSFCellStyle#getFontIndex()
     * @see com.quata.documentreader.xs.fc.hssf.usermodel.HSSFWorkbook#getFontAt(short)
     */
    public HSSFFont getFont(com.quata.documentreader.xs.fc.ss.usermodel.Workbook parentWorkbook) {
     ...
     * @see com.quata.documentreader.xs.fc.hssf.usermodel.HSSFPalette#getColor(short)
    ...
    private void checkDefaultBackgroundFills() {
      if (_format.getFillForeground() == com.quata.documentreader.xs.fc.hssf.util.HSSFColor.AUTOMATIC.index) {
    	  ...
    	  if (_format.getFillBackground() != (com.quata.documentreader.xs.fc.hssf.util.HSSFColor.AUTOMATIC.index+1))
    		  setFillBackgroundColor((short)(com.quata.documentreader.xs.fc.hssf.util.HSSFColor.AUTOMATIC.index+1));
      } else if (_format.getFillBackground() == com.quata.documentreader.xs.fc.hssf.util.HSSFColor.AUTOMATIC.index+1)
    	  //Now if the forground changes to a non-AUTOMATIC color the background resets itself!!!
    	  if (_format.getFillForeground() != com.quata.documentreader.xs.fc.hssf.util.HSSFColor.AUTOMATIC.index)
    		  setFillBackgroundColor(com.quata.documentreader.xs.fc.hssf.util.HSSFColor.AUTOMATIC.index);
    }
