 ...
 * 时间:              下午1:55:20
 */
package com.quata.documentreader.xs.ss.model.XLSModel;
...
import com.quata.documentreader.xs.common.shape.AChart;
...
import com.quata.documentreader.xs.constant.SSConstant;
import com.quata.documentreader.xs.fc.hssf.model.InternalSheet;
import com.quata.documentreader.xs.fc.hssf.model.InternalWorkbook;
import com.quata.documentreader.xs.fc.hssf.record.BlankRecord;
import com.quata.documentreader.xs.fc.hssf.record.CellValueRecordInterface;
import com.quata.documentreader.xs.fc.hssf.record.DefaultRowHeightRecord;
...
import com.quata.documentreader.xs.fc.hssf.record.RecordBase;
import com.quata.documentreader.xs.fc.hssf.record.RowRecord;
import com.quata.documentreader.xs.fc.hssf.usermodel.HSSFAutoShape;
import com.quata.documentreader.xs.fc.hssf.usermodel.HSSFChart;
import com.quata.documentreader.xs.fc.hssf.usermodel.HSSFChildAnchor;
import com.quata.documentreader.xs.fc.hssf.usermodel.HSSFClientAnchor;
import com.quata.documentreader.xs.fc.hssf.usermodel.HSSFFreeform;
import com.quata.documentreader.xs.fc.hssf.usermodel.HSSFLine;
import com.quata.documentreader.xs.fc.hssf.usermodel.HSSFPatriarch;
import com.quata.documentreader.xs.fc.hssf.usermodel.HSSFPicture;
import com.quata.documentreader.xs.fc.hssf.usermodel.HSSFPictureData;
import com.quata.documentreader.xs.fc.hssf.usermodel.HSSFRichTextString;
import com.quata.documentreader.xs.fc.hssf.usermodel.HSSFShape;
import com.quata.documentreader.xs.fc.hssf.usermodel.HSSFShapeGroup;
import com.quata.documentreader.xs.fc.hssf.usermodel.HSSFSheet;
import com.quata.documentreader.xs.fc.hssf.usermodel.HSSFTextbox;
import com.quata.documentreader.xs.fc.hssf.usermodel.HSSFWorkbook;
import com.quata.documentreader.xs.fc.hssf.util.HSSFPaneInformation;
import com.quata.documentreader.xs.fc.ss.util.HSSFCellRangeAddress;
import com.quata.documentreader.xs.fc.xls.ChartConverter;
import com.quata.documentreader.xs.java.awt.Rectangle;
import com.quata.documentreader.xs.ss.model.CellRangeAddress;
import com.quata.documentreader.xs.ss.model.baseModel.Cell;
import com.quata.documentreader.xs.ss.model.baseModel.Row;
import com.quata.documentreader.xs.ss.model.baseModel.Sheet;
import com.quata.documentreader.xs.ss.model.baseModel.Workbook;
import com.quata.documentreader.xs.ss.model.drawing.AnchorPoint;
import com.quata.documentreader.xs.ss.model.drawing.CellAnchor;
import com.quata.documentreader.xs.ss.model.sheetProperty.PaneInformation;
import com.quata.documentreader.xs.ss.util.ModelUtil;
import com.quata.documentreader.xs.ss.util.SectionElementFactory;
...
import com.quata.documentreader.xs.thirdpart.achartengine.chart.AbstractChart;
import com.quata.documentreader.xs.thirdpart.achartengine.chart.RoundChart;
import com.quata.documentreader.xs.thirdpart.achartengine.chart.XYChart;
import com.quata.documentreader.xs.thirdpart.achartengine.renderers.DefaultRenderer;
 ...
 * <p>
 */
public class ASheet extends Sheet implements com.quata.documentreader.xs.fc.ss.usermodel.Sheet
{
    ...
    protected ASheet(AWorkbook workbook, InternalSheet sheet)
    {
        ...
        List<com.quata.documentreader.xs.fc.hssf.util.ColumnInfo> hssfColumnInfoList = sheet.getColumnInfo();
        if(hssfColumnInfoList != null)
        {
            Iterator<com.quata.documentreader.xs.fc.hssf.util.ColumnInfo> iter = hssfColumnInfoList.iterator();
            while(iter.hasNext())
            {
                com.quata.documentreader.xs.fc.hssf.util.ColumnInfo hssfColumnInfo = iter.next();
                com.quata.documentreader.xs.ss.model.sheetProperty.ColumnInfo columnInfo = new com.quata.documentreader.xs.ss.model.sheetProperty.ColumnInfo(
