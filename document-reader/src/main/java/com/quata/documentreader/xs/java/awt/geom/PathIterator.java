...
package   com.quata.documentreader.xs.java.awt.geom;

/**
 * The <code>PathIterator</code> interface provides the mechanism 
 * for objects that implement the {@link   com.quata.documentreader.xs.fc.hwpf.usermodel.Shape Shape}
 ...
 * For example, the {@link   com.quata.documentreader.xs.thirdpart.achartengine.renderers.BasicStroke BasicStroke} object
 ...
 *
 * @see   com.quata.documentreader.xs.fc.hwpf.usermodel.Shape
 * @see   com.quata.documentreader.xs.thirdpart.achartengine.renderers.BasicStroke
 *
 * @version %I%, %G%
 * @author Jim Graham
 */
