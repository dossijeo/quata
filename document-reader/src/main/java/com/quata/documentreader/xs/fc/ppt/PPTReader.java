 ...
 * 时间:               下午4:23:51
 */
package com.quata.documentreader.xs.fc.ppt;
...
import com.quata.documentreader.xs.common.PaintKit;
import com.quata.documentreader.xs.common.autoshape.ExtendPath;
import com.quata.documentreader.xs.common.autoshape.pathbuilder.ArrowPathAndTail;
import com.quata.documentreader.xs.common.bg.BackgroundAndFill;
import com.quata.documentreader.xs.common.bg.Gradient;
import com.quata.documentreader.xs.common.bg.LinearGradientShader;
import com.quata.documentreader.xs.common.bg.RadialGradientShader;
import com.quata.documentreader.xs.common.bg.TileShader;
import com.quata.documentreader.xs.common.hyperlink.Hyperlink;
import com.quata.documentreader.xs.common.pictureefftect.PictureEffectInfoFactory;
import com.quata.documentreader.xs.common.shape.AbstractShape;
import com.quata.documentreader.xs.common.shape.ArbitraryPolygonShape;
import com.quata.documentreader.xs.common.shape.Arrow;
import com.quata.documentreader.xs.common.shape.AutoShape;
import com.quata.documentreader.xs.common.shape.GroupShape;
import com.quata.documentreader.xs.common.shape.IShape;
import com.quata.documentreader.xs.common.shape.LineShape;
import com.quata.documentreader.xs.common.shape.PictureShape;
import com.quata.documentreader.xs.common.shape.ShapeTypes;
import com.quata.documentreader.xs.common.shape.TableCell;
import com.quata.documentreader.xs.common.shape.TableShape;
import com.quata.documentreader.xs.common.shape.TextBox;
import com.quata.documentreader.xs.constant.AutoShapeConstant;
import com.quata.documentreader.xs.constant.EventConstant;
import com.quata.documentreader.xs.constant.MainConstant;
import com.quata.documentreader.xs.constant.wp.WPAttrConstant;
import com.quata.documentreader.xs.constant.wp.WPModelConstant;
import com.quata.documentreader.xs.fc.FCKit;
import com.quata.documentreader.xs.fc.ShapeKit;
import com.quata.documentreader.xs.fc.hslf.HSLFSlideShow;
import com.quata.documentreader.xs.fc.hslf.model.Fill;
import com.quata.documentreader.xs.fc.hslf.model.HeadersFooters;
import com.quata.documentreader.xs.fc.hslf.model.Line;
import com.quata.documentreader.xs.fc.hslf.model.MasterSheet;
import com.quata.documentreader.xs.fc.hslf.model.Notes;
import com.quata.documentreader.xs.fc.hslf.model.Shape;
import com.quata.documentreader.xs.fc.hslf.model.ShapeGroup;
import com.quata.documentreader.xs.fc.hslf.model.Sheet;
import com.quata.documentreader.xs.fc.hslf.model.SimpleShape;
import com.quata.documentreader.xs.fc.hslf.model.Slide;
import com.quata.documentreader.xs.fc.hslf.model.SlideMaster;
import com.quata.documentreader.xs.fc.hslf.model.TextShape;
import com.quata.documentreader.xs.fc.hslf.model.TitleMaster;
import com.quata.documentreader.xs.fc.hslf.record.BinaryTagDataBlob;
import com.quata.documentreader.xs.fc.hslf.record.ClientVisualElementContainer;
import com.quata.documentreader.xs.fc.hslf.record.DocumentAtom;
import com.quata.documentreader.xs.fc.hslf.record.OEPlaceholderAtom;
import com.quata.documentreader.xs.fc.hslf.record.PositionDependentRecordContainer;
import com.quata.documentreader.xs.fc.hslf.record.Record;
import com.quata.documentreader.xs.fc.hslf.record.SlideAtom;
import com.quata.documentreader.xs.fc.hslf.record.SlideProgBinaryTagContainer;
import com.quata.documentreader.xs.fc.hslf.record.SlideProgTagsContainer;
import com.quata.documentreader.xs.fc.hslf.record.SlideShowSlideInfoAtom;
import com.quata.documentreader.xs.fc.hslf.record.TimeAnimateBehaviorContainer;
import com.quata.documentreader.xs.fc.hslf.record.TimeBehaviorContainer;
import com.quata.documentreader.xs.fc.hslf.record.TimeColorBehaviorContainer;
import com.quata.documentreader.xs.fc.hslf.record.TimeCommandBehaviorContainer;
import com.quata.documentreader.xs.fc.hslf.record.TimeEffectBehaviorContainer;
import com.quata.documentreader.xs.fc.hslf.record.TimeMotionBehaviorContainer;
import com.quata.documentreader.xs.fc.hslf.record.TimeNodeAttributeContainer;
import com.quata.documentreader.xs.fc.hslf.record.TimeNodeContainer;
import com.quata.documentreader.xs.fc.hslf.record.TimeRotationBehaviorContainer;
import com.quata.documentreader.xs.fc.hslf.record.TimeScaleBehaviorContainer;
import com.quata.documentreader.xs.fc.hslf.record.TimeSetBehaviorContainer;
import com.quata.documentreader.xs.fc.hslf.record.TimeVariant;
import com.quata.documentreader.xs.fc.hslf.record.VisualShapeAtom;
import com.quata.documentreader.xs.fc.hslf.record.SlideAtom.SSlideLayoutAtom;
import com.quata.documentreader.xs.fc.hslf.usermodel.PictureData;
import com.quata.documentreader.xs.fc.hslf.usermodel.RichTextRun;
import com.quata.documentreader.xs.fc.hslf.usermodel.SlideShow;
import com.quata.documentreader.xs.fc.ppt.bulletnumber.BulletNumberManage;
import com.quata.documentreader.xs.java.awt.Dimension;
import com.quata.documentreader.xs.java.awt.Rectangle;
import com.quata.documentreader.xs.java.awt.Rectanglef;
import com.quata.documentreader.xs.java.awt.geom.Rectangle2D;
import com.quata.documentreader.xs.pg.animate.ShapeAnimation;
import com.quata.documentreader.xs.pg.model.PGModel;
import com.quata.documentreader.xs.pg.model.PGNotes;
import com.quata.documentreader.xs.pg.model.PGSlide;
import com.quata.documentreader.xs.simpletext.font.FontTypefaceManage;
import com.quata.documentreader.xs.simpletext.model.AttrManage;
import com.quata.documentreader.xs.simpletext.model.IAttributeSet;
import com.quata.documentreader.xs.simpletext.model.LeafElement;
import com.quata.documentreader.xs.simpletext.model.ParagraphElement;
import com.quata.documentreader.xs.simpletext.model.SectionElement;
import com.quata.documentreader.xs.ss.util.format.NumericFormatter;
import com.quata.documentreader.xs.system.AbstractReader;
import com.quata.documentreader.xs.system.BackReaderThread;
...
{   
    ...
    private com.quata.documentreader.xs.common.borders.Line getShapeLine(SimpleShape shape)
    {
    	return getShapeLine(shape, false);
    }
    
    private com.quata.documentreader.xs.common.borders.Line getShapeLine(SimpleShape shape, boolean isTableCellLine)
    {
        com.quata.documentreader.xs.common.borders.Line line = null;
        if(shape != null && shape.hasLine())
        {
             ...
             com.quata.documentreader.xs.java.awt.Color color = ((SimpleShape)shape).getLineColor();
             
             if(color != null)
             {
            	 line = new com.quata.documentreader.xs.common.borders.Line();
    ...
    private BackgroundAndFill converFill(PGSlide pgSlide, Fill fill)
    {
        ...
        {        	
                    ...
                    || type == BackgroundAndFill.FILL_SHADE_SHAPE)
            {
            	...
            	com.quata.documentreader.xs.java.awt.Color fillColor = fill.getForegroundColor();
            	com.quata.documentreader.xs.java.awt.Color fillbackColor = fill.getFillbackColor();
    ...
    private void processNotes(PGSlide pgSlide, Notes notes)
    {
        if (notes != null)
        {
            ...
            for (Shape shape : notes.getShapes())
            {
                ...
                if(shape instanceof com.quata.documentreader.xs.fc.hslf.model.AutoShape  // 文本框
                    || shape instanceof com.quata.documentreader.xs.fc.hslf.model.TextBox)  // 占位符
                {
...
//        }
        ...
        if (shape instanceof Line
            || shape instanceof com.quata.documentreader.xs.fc.hslf.model.Freeform
            || shape instanceof com.quata.documentreader.xs.fc.hslf.model.AutoShape
            || shape instanceof com.quata.documentreader.xs.fc.hslf.model.TextBox
            || shape instanceof com.quata.documentreader.xs.fc.hslf.model.Picture)
        {  
            if (shape instanceof Line)
            {
                if (line != null)
            ...
            else if(shape instanceof com.quata.documentreader.xs.fc.hslf.model.Freeform)
            {              
                if (fill != null || line != null)
                {
                    ...
                    if (startArrowType > 0)
                    {
                    	ArrowPathAndTail arrowPathAndTail = ((com.quata.documentreader.xs.fc.hslf.model.Freeform)shape).getStartArrowPathAndTail(rect);
                    ...
                    if (endArrowType > 0)
                    {                        
                    	ArrowPathAndTail arrowPathAndTail = ((com.quata.documentreader.xs.fc.hslf.model.Freeform)shape).getEndArrowPathAndTail(rect);
                    	if(arrowPathAndTail != null && arrowPathAndTail.getArrowPath() != null)
                        {
                    ...
                    Path[] paths = ((com.quata.documentreader.xs.fc.hslf.model.Freeform)shape).getFreeformPath(rect,
            ...
            else if(shape instanceof com.quata.documentreader.xs.fc.hslf.model.AutoShape
                    || shape instanceof com.quata.documentreader.xs.fc.hslf.model.TextBox)
            {
                // autoShape
            ...
            // 图片
            else if(shape instanceof com.quata.documentreader.xs.fc.hslf.model.Picture)
            {   
                com.quata.documentreader.xs.fc.hslf.model.Picture poiPic = (com.quata.documentreader.xs.fc.hslf.model.Picture)shape;
        ...
        else if(shape instanceof com.quata.documentreader.xs.fc.hslf.model.Table)
        {
            com.quata.documentreader.xs.fc.hslf.model.Table poiTable = (com.quata.documentreader.xs.fc.hslf.model.Table)shape;
            if (poiTable != null)
            {
     ...
     * @param pgSlide
     */
    private void processTable(PGSlide pgSlide, com.quata.documentreader.xs.fc.hslf.model.Table poiTable, GroupShape parent, int slideType)
    {
        ...
        for (int i = 0; i < rows; i++)
        {
            for (int j = 0; j < columns; j++)
            {
                ...
                com.quata.documentreader.xs.fc.hslf.model.TableCell poiCell = poiTable.getCell(i, j);
                if (poiCell != null)
                {
        ...
        {
        	com.quata.documentreader.xs.common.borders.Line aLine = getShapeLine(line, true);
            if (aLine != null)
            {
    ...
    private int getBorderColor(Line line)
    {
        if (line != null)
        {
            com.quata.documentreader.xs.java.awt.Color color = line.getLineColor();
            if (color != null)
            {
    ...
    private void processNormalTextShape(TextBox tb, TextShape ts, Rectangle rect, int slideType, int placeHolderID)
    {
        ...
        if (text != null && text.trim().length() > 0)
        {
            ...
            int len = text.length();
            com.quata.documentreader.xs.fc.hslf.model.Hyperlink[] links = ts.getTextRun().getHyperlinks();
            int start = 0;
            // title type just a paragraph needs be processed specially
            if (ts.getTextRun().getRunType() != com.quata.documentreader.xs.fc.hslf.record.TextHeaderAtom.TITLE_TYPE)
            {
                for (int i = 0; i < len; i++)
                {
                    if (abortReader)
    ...
    private void processParagraph(SectionElement secElem, TextShape ts, String text,
                                  com.quata.documentreader.xs.fc.hslf.model.Hyperlink[] links, int start, int end, int placeHolderID)
    {
        ...
        com.quata.documentreader.xs.fc.hslf.record.TextRulerAtom ruler = ts.getTextRun().getTextRuler();
        if (ruler != null)
        {
...
//      }
     ...
     * 
     */
    private int converterColor(com.quata.documentreader.xs.java.awt.Color color)
    {
//        if(color.getAlpha() == 0)
//        {
