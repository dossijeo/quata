...
import   com.quata.documentreader.xs.common.ICustomDialog;
...
import   com.quata.documentreader.xs.constant.DialogConstant;
...
import   com.quata.documentreader.xs.system.AbstractControl;
    ...
    public void actionEvent(int actionID, final Object obj)
    {
        switch (actionID)
        {
            ...
            case EventConstant.PG_NOTE_ID:                          //show notes
                ...
                vector.add(text);
                new   com.quata.documentreader.xs.pg.dialog.NotesDialog(this, getMainFrame().getActivity(), null, vector,
