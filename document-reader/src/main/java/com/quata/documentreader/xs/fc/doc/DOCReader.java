...
package com.quata.documentreader.xs.fc.doc;
...
import com.quata.documentreader.xs.common.bookmark.Bookmark;
import com.quata.documentreader.xs.common.borders.Border;
import com.quata.documentreader.xs.common.borders.Borders;
import com.quata.documentreader.xs.common.borders.Line;
import com.quata.documentreader.xs.common.bulletnumber.ListData;
import com.quata.documentreader.xs.common.bulletnumber.ListLevel;
...
import com.quata.documentreader.xs.common.shape.WPAbstractShape;
import com.quata.documentreader.xs.common.shape.WPAutoShape;
import com.quata.documentreader.xs.common.shape.WPGroupShape;
import com.quata.documentreader.xs.common.shape.WPPictureShape;
...
import com.quata.documentreader.xs.fc.ddf.EscherContainerRecord;
import com.quata.documentreader.xs.fc.ddf.EscherOptRecord;
import com.quata.documentreader.xs.fc.ddf.EscherProperties;
import com.quata.documentreader.xs.fc.ddf.EscherSimpleProperty;
import com.quata.documentreader.xs.fc.ddf.EscherTextboxRecord;
import com.quata.documentreader.xs.fc.hwpf.HWPFDocument;
import com.quata.documentreader.xs.fc.hwpf.model.FieldsDocumentPart;
import com.quata.documentreader.xs.fc.hwpf.model.ListFormatOverride;
import com.quata.documentreader.xs.fc.hwpf.model.ListTables;
import com.quata.documentreader.xs.fc.hwpf.model.POIListData;
import com.quata.documentreader.xs.fc.hwpf.model.POIListLevel;
import com.quata.documentreader.xs.fc.hwpf.model.PicturesTable;
import com.quata.documentreader.xs.fc.hwpf.usermodel.Bookmarks;
import com.quata.documentreader.xs.fc.hwpf.usermodel.BorderCode;
import com.quata.documentreader.xs.fc.hwpf.usermodel.CharacterRun;
import com.quata.documentreader.xs.fc.hwpf.usermodel.Field;
import com.quata.documentreader.xs.fc.hwpf.usermodel.HWPFAutoShape;
import com.quata.documentreader.xs.fc.hwpf.usermodel.HWPFShape;
import com.quata.documentreader.xs.fc.hwpf.usermodel.HWPFShapeGroup;
import com.quata.documentreader.xs.fc.hwpf.usermodel.HeaderStories;
import com.quata.documentreader.xs.fc.hwpf.usermodel.InlineWordArt;
import com.quata.documentreader.xs.fc.hwpf.usermodel.LineSpacingDescriptor;
import com.quata.documentreader.xs.fc.hwpf.usermodel.OfficeDrawing;
import com.quata.documentreader.xs.fc.hwpf.usermodel.OfficeDrawings;
import com.quata.documentreader.xs.fc.hwpf.usermodel.POIBookmark;
import com.quata.documentreader.xs.fc.hwpf.usermodel.Paragraph;
import com.quata.documentreader.xs.fc.hwpf.usermodel.PictureType;
import com.quata.documentreader.xs.fc.hwpf.usermodel.Range;
import com.quata.documentreader.xs.fc.hwpf.usermodel.Section;
import com.quata.documentreader.xs.fc.hwpf.usermodel.Table;
import com.quata.documentreader.xs.fc.hwpf.usermodel.TableCell;
import com.quata.documentreader.xs.fc.hwpf.usermodel.TableRow;
import com.quata.documentreader.xs.fc.util.LittleEndian;
import com.quata.documentreader.xs.java.awt.Rectangle;
import com.quata.documentreader.xs.java.util.Arrays;
...
import com.quata.documentreader.xs.simpletext.model.IElement;
...
import com.quata.documentreader.xs.simpletext.view.PageAttr;
import com.quata.documentreader.xs.ss.util.ModelUtil;
import com.quata.documentreader.xs.system.AbstractReader;
import com.quata.documentreader.xs.system.IControl;
import com.quata.documentreader.xs.wp.model.CellElement;
import com.quata.documentreader.xs.wp.model.HFElement;
import com.quata.documentreader.xs.wp.model.RowElement;
import com.quata.documentreader.xs.wp.model.TableElement;
import com.quata.documentreader.xs.wp.model.WPDocument;
    ...
    private BackgroundAndFill converFill(HWPFAutoShape shape, OfficeDrawing drawing, int shapeType)
    {
        ...
        if (shape != null)
        {
            		...
            		|| type == BackgroundAndFill.FILL_SHADE_RECT || type == BackgroundAndFill.FILL_SHADE_SHAPE)
            {
            	...
            	com.quata.documentreader.xs.java.awt.Color fillColor = shape.getForegroundColor();
            	com.quata.documentreader.xs.java.awt.Color fillbackColor = shape.getFillbackColor();
   ...
   /*         	byte[] data = drawing.getBGPictureData(shape.getBackgroundPictureIdx());
    ...
    private void processWordArtTextbox(EscherContainerRecord escherContainer, WPAutoShape autoShape)
    {
		...
		if(text != null && text.length() > 0)
		{
            ...
            // 字符颜色
            com.quata.documentreader.xs.java.awt.Color color = ShapeKit.getForegroundColor(escherContainer, null, MainConstant.APPLICATION_TYPE_PPT);
            if(color != null)
            {
    ...
    private boolean processShape(CharacterRun run, IElement leaf, boolean isWrap, int runIndex)
    {
        ...
        else
        {
            ...
            com.quata.documentreader.xs.fc.hwpf.usermodel.Picture pic = pictureTable.extractPicture(control.getSysKit().getPictureManage().getPicTempPath(),
                run, false);
