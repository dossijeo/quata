 ...
 * 时间:              上午9:08:14
 */
package com.quata.documentreader.xs.common.pictureefftect;
...
public class PictureEffectInfoFactory
{
    ...
    public static PictureEffectInfo getPictureEffectInfor(com.quata.documentreader.xs.fc.hwpf.usermodel.Picture pic)
    {
    	if(pic == null)
        {
            return null;
