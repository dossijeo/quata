...
package   com.quata.documentreader.xs.fc.hslf.usermodel;
...
import   com.quata.documentreader.xs.fc.hslf.exceptions.CorruptPowerPointFileException;
import   com.quata.documentreader.xs.fc.hslf.model.HeadersFooters;
import   com.quata.documentreader.xs.fc.hslf.model.Hyperlink;
import   com.quata.documentreader.xs.fc.hslf.model.MovieShape;
...
import   com.quata.documentreader.xs.fc.hslf.record.Document;
import   com.quata.documentreader.xs.fc.hslf.record.DocumentAtom;
import   com.quata.documentreader.xs.fc.hslf.record.ExAviMovie;
import   com.quata.documentreader.xs.fc.hslf.record.ExControl;
import   com.quata.documentreader.xs.fc.hslf.record.ExHyperlink;
import   com.quata.documentreader.xs.fc.hslf.record.ExHyperlinkAtom;
import   com.quata.documentreader.xs.fc.hslf.record.ExMCIMovie;
import   com.quata.documentreader.xs.fc.hslf.record.ExObjList;
import   com.quata.documentreader.xs.fc.hslf.record.ExObjListAtom;
import   com.quata.documentreader.xs.fc.hslf.record.ExOleObjAtom;
import   com.quata.documentreader.xs.fc.hslf.record.ExVideoContainer;
import   com.quata.documentreader.xs.fc.hslf.record.ExtendedParagraphHeaderAtom;
import   com.quata.documentreader.xs.fc.hslf.record.ExtendedPresRuleContainer;
import   com.quata.documentreader.xs.fc.hslf.record.FontCollection;
import   com.quata.documentreader.xs.fc.hslf.record.HeadersFootersContainer;
import   com.quata.documentreader.xs.fc.hslf.record.PersistPtrHolder;
import   com.quata.documentreader.xs.fc.hslf.record.PositionDependentRecord;
...
import   com.quata.documentreader.xs.fc.hslf.record.RecordContainer;
import   com.quata.documentreader.xs.fc.hslf.record.RecordTypes;
import   com.quata.documentreader.xs.fc.hslf.record.SlideListWithText;
import   com.quata.documentreader.xs.fc.hslf.record.SlidePersistAtom;
import   com.quata.documentreader.xs.fc.hslf.record.ExtendedPresRuleContainer.ExtendedParaAtomsSet;
import   com.quata.documentreader.xs.fc.hslf.record.SlideListWithText.SlideAtomsSet;
    ...
    private void buildSlidesAndNotes()
    {
        ...
        if (masterSLWT != null)
        {
            ...
            for (int i = 0; i < masterSets.length; i++)
            {
                ...
                if (r instanceof   com.quata.documentreader.xs.fc.hslf.record.Slide)
                {
                    TitleMaster master = new TitleMaster((  com.quata.documentreader.xs.fc.hslf.record.Slide)r, sheetNo);
                    master.setSlideShow(this);
                    tmr.add(master);
                }
                else if (r instanceof   com.quata.documentreader.xs.fc.hslf.record.MainMaster)
                {
                    SlideMaster master = new SlideMaster((  com.quata.documentreader.xs.fc.hslf.record.MainMaster)r, sheetNo);
                    master.setSlideShow(this);
                    mmr.add(master);
                }
            }
        ...
        // notesSLWT
          com.quata.documentreader.xs.fc.hslf.record.Notes[] notesRecords;
        SlideAtomsSet[] notesSets = new SlideAtomsSet[0];
        Hashtable<Integer, Integer> slideIdToNotes = new Hashtable<Integer, Integer>();
        if (notesSLWT == null)
        {
            // None
            notesRecords = new   com.quata.documentreader.xs.fc.hslf.record.Notes[0];
        }
        else
        {
            // Match up the records and the SlideAtomSets
            notesSets = notesSLWT.getSlideAtomsSets();
            ArrayList<  com.quata.documentreader.xs.fc.hslf.record.Notes> notesRecordsL = new ArrayList<  com.quata.documentreader.xs.fc.hslf.record.Notes>();
            for (int i = 0; i < notesSets.length; i++)
            {
                ...
                if (r instanceof   com.quata.documentreader.xs.fc.hslf.record.Notes)
                {
                      com.quata.documentreader.xs.fc.hslf.record.Notes notesRecord = (  com.quata.documentreader.xs.fc.hslf.record.Notes)r;
            ...
            notesRecords = new   com.quata.documentreader.xs.fc.hslf.record.Notes[notesRecordsL.size()];
            notesRecords = notesRecordsL.toArray(notesRecords);
        }

        // Now, do the same thing for our slides
          com.quata.documentreader.xs.fc.hslf.record.Slide[] slidesRecords;
        SlideAtomsSet[] slidesSets = new SlideAtomsSet[0];
        if (slidesSLWT == null)
        {
            // None
            slidesRecords = new   com.quata.documentreader.xs.fc.hslf.record.Slide[0];
        }
        else
        {
            // Match up the records and the SlideAtomSets
            slidesSets = slidesSLWT.getSlideAtomsSets();
            slidesRecords = new   com.quata.documentreader.xs.fc.hslf.record.Slide[slidesSets.length];
            for (int i = 0; i < slidesSets.length; i++)
            {
                ...
                if (r instanceof   com.quata.documentreader.xs.fc.hslf.record.Slide)
                {
                    slidesRecords[i] = (  com.quata.documentreader.xs.fc.hslf.record.Slide)r;
                }
                /*else
                {
