...
public fun richTextId(): String = "rich-${kotlin.random.Random.nextLong().toString(16)}"

public sealed interface QuataRichTextAction {
    fun reduce(state: QuataRichTextDocumentState): QuataRichTextDocumentState
}

public data class QuataRichTextDocumentState(
...
public data class QuataRichTextBlockModel(
    val id: String,
...
public data class InsertRichTextBlock(
...
public data class InsertRichTextBlocks(
    val blocks: List<QuataRichTextBlockModel>,
    val atIndex: Int,
...
public data class DeleteRichTextBlocks(
...
public data class ReorderRichTextBlocks(
    val blocks: List<QuataRichTextBlockModel>,
    val selectedBlockId: String?,
    val selectedBlockIds: List<String>,
) : QuataRichTextAction {
...
public data class ConvertRichTextBlockType(
    val blockId: String,
    val type: RichTextBlockType,
) : QuataRichTextAction {
    override fun reduce(state: QuataRichTextDocumentState): QuataRichTextDocumentState {
...
public data class SetRichTextTodoChecked(
    val blockId: String,
    val checked: Boolean,
) : QuataRichTextAction {
    override fun reduce(state: QuataRichTextDocumentState): QuataRichTextDocumentState {
...
public data class ShiftRichTextIndent(
    val blockId: String,
    val delta: Int,
    val maxIndent: Int,
) : QuataRichTextAction {
...
public data class ToggleRichTextHeading(
    val blockId: String,
    val level: Int,
) : QuataRichTextAction {
    override fun reduce(state: QuataRichTextDocumentState): QuataRichTextDocumentState {
...
public data class UpdateRichTextBlockInline(
    val blockId: String,
    val text: String,
...
public fun QuataRichTextBlock.toModel(): QuataRichTextBlockModel {
...
public fun QuataRichTextBlockModel.toBlock(): QuataRichTextBlock {
...
public fun QuataRichTextBlockModel.selectionRange(): TextRange {
