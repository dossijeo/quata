...
test("Official editor Web real evidence is opt-in, redacted, and reversible", () => {
  ...
  assert.match(runner, /fillSemanticInput\(page, "official-editor-advanced-title", titleText\)/);
  assert.match(runner, /fillSemanticInput\(page, "official-editor-advanced-summary", summaryText\)/);
  ...
  assert.match(runner, /#official-editor-long-body/);
  assert.match(runner, /fillSemanticInput\(page, "quata-portable-rich-text-field", value\)/);
