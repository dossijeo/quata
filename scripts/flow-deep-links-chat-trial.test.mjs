...
for(const pendingOperation of ["refreshAttempt","revocation","iosSession","androidSession"])test(`closed browser with unresolved ${pendingOperation} preserves journals before any retirement`,{skip:process.platform!=="win32"},async()=>directory(async privateDirectory=>{
