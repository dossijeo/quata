...
test('common UI controls use portable Material ImageVectors instead of font glyphs', () => {
  ...
  assert.match(reelHost, /FeedReelPlaybackControlsActionRailReserve = 64\.dp/);
  assert.match(reelHost, /FeedReelPlaybackIconScrimAlpha = 0\.42f/);
  assert.match(reelHost, /private fun FeedReelPlaybackControlButton\(/);
  ...
  assert.doesNotMatch(reelHost, /end = 74\.dp/);
