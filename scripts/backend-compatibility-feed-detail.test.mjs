...
assert.equal(detailEvidenceEvent([{ method:'GET', status:200, table:'posts', query:'select=id&order=x&id=eq.post_7', payloadPostId:'post_7' }], 'post_7').payloadPostId, 'post_7');
