...
export async function executeDeepLinkWebTrial({client,serviceKey,chromium,chrome,root,distribution,
  privateDirectory,outputDirectory,supabaseCli,expected,authenticationMode,sessionMode,sessionDeliveryMode,targetMode}) {
  ...
  const ui=createDeepLinkWebTrial({chromium,chrome,distribution,outputDirectory,backendUrl,publicKey,authenticationMode,sessionMode,sessionDeliveryMode,targetMode});
