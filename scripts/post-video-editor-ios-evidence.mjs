...
export QUATA_IOS_POST_VIDEO_EDITOR_UI_TIMEOUT_SECONDS=${sourceHasAudio ? "'420'" : "'660'"}
...
export QUATA_IOS_POST_VIDEO_EDITOR_EXPORT_TIMEOUT_SECONDS=${sourceHasAudio ? "'180'" : "'420'"}
