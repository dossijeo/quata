...
import plistlib, sys
path, credentials, conversation, message, marker, profile_marker, profile_id, profile_follow, profile_lists, profile_content, profile_roles_safety, menu_surface, keyboard_menu, attachments_audio, attachment_picker, group_sos, editable_message, editable_marker, composer, reply, edit, forward_query, attachment_document, attachment_audio, attachment_image, attachment_video, audio_recording_marker, profile_content_post, profile_content_comment, profile_content_attachment, profile_content_ui_comment, picker_opt_in, picker_source, picker_outcome, picker_reason, picker_path, picker_name, picker_mime, picker_marker = sys.argv[1:]
