...
test("audio attachment player exposes stable common playback anchors", () => {
  ...
  assert.doesNotMatch(iosAudioPlayerHost, /requestedStartTimeSeconds/);
  ...
  assert.match(iosAudioPlayerHost, /AudioPlaybackState\(true, it\.playing, nativePositionMillis, durationMillis\)/);
