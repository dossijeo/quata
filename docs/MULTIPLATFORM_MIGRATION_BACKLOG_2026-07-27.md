...
**Corte verificado:** `main` `185960769011f03d644130012fe8051ad536e9bf` (2026-07-29).
...
| --- | --- | --- | --- |
| IOS-AUTH-001 | P0 | En validación / HOLD | Recorrer login, refresh, logout y cold start con cuenta aislada. El resultado sólo pasa a GO con sesión limpiada, evidencia no secreta y revisión; no inferirlo de contratos de ruta. |
