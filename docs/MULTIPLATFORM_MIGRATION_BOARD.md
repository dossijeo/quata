...
| [#206](https://github.com/dossijeo/quata/pull/206) | pendiente | Feed iOS publica duración/posición reales y `seekTo` desde el surface nativo hacia el chrome Compose común; XCTest genera un MP4 local y verifica duración + seek. No declara GO global de `OVR-MEDIA`. |
