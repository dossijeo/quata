...
| Cuenta/Perfil/SOS (#156; candidato SOS `301d19fa`) | COMÚN con límites reducidos | `ProfileScreenHost` común integrado; postflight iOS de Feed/perfil público, auth, relanzamiento y Cuenta/Perfil visual PASS. Candidato legal local pendiente añade en Cuenta la sección común de documentos legales y apertura por `DocumentOpenService`. `SOS-CONTACTS` queda reducido sobre `301d19fab5c1c6f221f1deed14513f126d78e7f2`: anclas comunes `profile.sos.*`, Web/Wasm E2E con bridge localhost-only y capturas landscape, Android instrumented 2/2 e iOS XCTest 1/1 en simulador real. Rama apilada `codex/sos-contacts-remote-limits` Product/Evidence SHA `cdadcbb120689e2391321d86b005f6fef9a1afa0` añade SB-06 real contra Supabase con perfiles aprobados, snapshot/restauración exacta de contactos y reporte redactado; manifest `docs/candidate-attestations/profile-sos-remote-limits.json`. | Avatar Web continúa contractual sin mutación E2E acreditada. SOS no declara GO completo: faltan 5/5 visual, permisos/contact picker y errores/rollback forzados desde UI. |
