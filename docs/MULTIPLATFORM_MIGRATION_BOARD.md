...
2. Completar el candidato #215 para `SCR-AUTH-RECOVERY`: anclas comunes, tests de ViewModel/repositorio, fixture iOS y evidencia Web hermetica `WEB-AUTH-RECOVERY-001` ya preparados; quedan consulta real de pregunta, cuenta ausente/error, reset reversible autorizado, retorno a Login, comparativa visual Android-Wasm-iOS y limpieza/backend sin DDL/RLS/grants.
