...
| MP-A04 | P1 | Shell/navegación iOS por verticales: Notifications/Official, después Profile/SOS; luego Communities, Composer, Settings, WhatsNew y External Share sin datos Swift de ejemplo. | Runtime/sesión pública para repositorios reales; push/dispositivo bloqueado por credenciales (SB-08). | En revisión | `259b5ea` integra Notifications/Official; `4e18882` integra Profile/SOS con ruta interna autenticada y CI exactas #30161875977/#30166431406 verdes (Kotlin, framework, Xcode, XCTest/UI). La rama `codex/next-ios-communities-shell` añade Communities como ruta interna autenticada, con snapshot PostgREST/URLSession y Chat reutilizado; espera compilación/CI exacta. No hay deep link público, mutaciones, media, roles ni E2E iOS declarados. |
