...
<!-- Actualizacion operativa 2026-08-09: base medida main ce399dcbd2946b69729e64a6c66beb794bdd7676. Candidato RELEASE-HISTORY-COMMON-SCROLL-SEMANICS-001: `ReleaseHistoryContent` comun gana tags de evidencia `release-history-*`, cierre/prev/next verificables y pagina con scroll vertical para notas largas; Android/Web/iOS conservan el montaje comun y no aceptan `onBack = {}`. No declara GO de `SCR-RELEASE-HISTORY` hasta comparativa visual/operativa y navegacion real de retorno. -->
