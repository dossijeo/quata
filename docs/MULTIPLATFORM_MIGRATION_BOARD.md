...
| pendiente | `6620134d` | `SCR-NOTIFICATIONS` declara GO local en `codex/notifications-go`: anclas comunes, contrato común de tap/dismiss/retry, Web conectado al `ChatRepository` montado, copy Android/Wasm/iOS sin mojibake y evidencias Android/Web/iOS sobre el mismo candidato. Pendiente PR/CI/merge para cerrar en `main`; borrar la rama tras integrar. |
