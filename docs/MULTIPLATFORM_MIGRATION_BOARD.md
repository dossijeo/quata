...
| Servicios iOS base | Integrado | AVFoundation/deep links (#6), grabación/reproducción/caché de audio AVFoundation, MIME de galería y UTI Office (#14/#16), APNs bridge (#19), Quick Look (#30), Keychain con renovación de sesión (#13), transporte Auth nativo, ContactsUI, thumbnails Quick Look de documentos y thumbnails AVFoundation de vídeo locales. XCTest cubre la admisión determinista de thumbnail de vídeo (URL local, remoto/malformado, ancho, tiempo y fallback de archivo ausente) sin afirmar decodificación de un fixture. |
