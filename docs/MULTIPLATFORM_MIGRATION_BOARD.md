...
3. Completar los postflights de `SCR-NOTIFICATIONS`, `SCR-CONVERSATIONS`, `SCR-RELEASE-HISTORY`, `SCR-ACCOUNT`, `SCR-SOS` y `SCR-CREATE-POST`; una raiz integrada no equivale a GO. `SCR-WHATS-NEW` queda en GO candidato local hasta certificacion PR/CI y merge.
...
<!-- Actualizacion operativa 2026-08-10: candidato local de la rama `codex/whats-new-go` cierra como GO candidato `SCR-WHATS-NEW`: `WhatsNewContent` expone anclas comunes `whats-new-*`; Android pasa `WHATS-NEW-ANDROID-COMMON-001` con dos paginas, cierre y segundo montaje sin repeticion; Web/Wasm pasa `WHATS-NEW-WEB-COMMON-001` contra el bundle `wasmJsBrowserDistribution` con localStorage reset/seen/segunda apertura; iOS pasa build SimulatorSigned Intel y `WHATS-NEW-IOS-COMMON-001` en el simulador 48950F56-C309-4AA7-921F-D76C6042AC2C con `WhatsNew.xcresult`. Evidencias: `build-reports/android/whats-new-evidence/whats-new-evidence/android-whats-new-common-evidence.json`, `build-reports/web/whats-new-evidence.json`, `build-reports/ios/whats-new-ui/ios-whats-new-evidence.json`. Pendiente certificacion PR/CI antes de declararlo integrado en `main`. -->
