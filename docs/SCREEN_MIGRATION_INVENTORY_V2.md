...
| `ACCOUNT-RECOVERY-SECRET` | Aceptación local Android/Web verificada · iOS, certificación/integración pendientes | Cuenta → pregunta/respuesta → recuperación | Product/Evidence Android `1394c8471ff26674c402f97bd4efa6b02b44975d`; Web `88be97f9f79aac13a07aa995b3bf27f4535eb6fc`. Productor real desde Cuenta, lectura permitida sin respuesta, recuperación autorizada y restitución acreditados localmente. Evidencia y límites en `docs/recovery-secret/salvage-and-runner-design.md`. | Provisional: NO es GO integrado. No certifica Feed ni continuidad normal de navegación; Android reabre Cuenta por la entrada de evidencia, Web abre Login explícitamente después del reset. No cierra iOS, ACCOUNT-DETAILS ni padres/vecinos por inferencia. No aceptar SQL de preparación como productor ni asumir disponibilidad actual del endpoint; escritura desactivada después del ensayo. | S08,S14,S01 · [fuente Android](https://github.com/dossijeo/quata/blob/1394c8471ff26674c402f97bd4efa6b02b44975d/app/src/main/java/com/quata/feature/auth/presentation/recovery/ForgotPasswordScreen.kt) |
