...
2. Cerrar la evidencia real de `SCR-OFFICIAL-EDITOR` desde `main` posterior a #194 usando las anclas comunes:
   publicacion, video iOS, permisos, error, lectura backend, limpieza y comparativa Android-Wasm-iOS.
