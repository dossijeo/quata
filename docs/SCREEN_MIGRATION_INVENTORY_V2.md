...
2. Revalidar `SCR-OFFICIAL-EDITOR` sobre el candidato PR #217 `3c0a0a50dd59f759d5b36aa94f070f1f0c615deb` antes de integrarlo:
   Web/Wasm ya acredita post exacto creado con lectura autenticada, gate visual por pixeles, limpieza y captura real en `build-reports/web/official-editor-final-visual-evidence-r10.json`; el postflight RLS actual pasa en `build-reports/official-editor/real-backend-evidence-3c0a0a50.json`. Falta repetir Android/iOS y la comparativa Android-Wasm-iOS final sobre este SHA, sin falsos positivos.
