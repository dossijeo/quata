...
| `SCR-RELEASE-HISTORY` | `ReleaseHistoryScreen` | Catálogo, navegación desde About/Novedades, detalle y retorno. | **COMÚN con límites.** #159 integrado; #210 añade tags comunes de evidencia, cierre/prev/next verificables y scroll común para notas largas; #212 conecta About común Android/Web/iOS con navegación real hacia este historial. | Validar catálogo, navegación About/Novedades -> Historial, cierre, anterior/siguiente, deep link y retorno en ruta real con comparativa visual Android-Wasm-iOS. |
...
| `FLOW-TRANSLATOR` | Traductor Fang y backdrop global | Feed, Oficial, Chat y comentarios; Android captura fondo y monta modo global. | **PARCIAL/COMÚN con límites.** #204 elimina los triggers inertes de comentarios Feed/Official en Web/iOS, mueve el motor FastText a `core/commonMain`, conecta loaders reales de modelo en Android/Web/iOS y reutiliza el overlay común en `designsystem/commonMain`. Persisten límites fuera de comentarios Feed/Official: Chat, captura/render global Android-equivalente, evidencias visuales comparativas y salida/errores en todos los orígenes. |
