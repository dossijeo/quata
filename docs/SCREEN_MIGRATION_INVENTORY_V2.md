...
| `ACCOUNT-PASSWORD-LEGACY` | Investigación estática revisada y resuelta localmente · integración documental pendiente | Cuenta → campo histórico de contraseña | Fuente 1.0.4 y AAB publicado v32 trazados: UI → NewPasswordChanged → ProfileUpdate → patch → updateProfile. El campo nunca se incluye en el patch remoto; no existía escritura funcional de esa contraseña desde Cuenta. Mantener la explicación migrada y la recuperación existente; no crear cambio autenticado nuevo. [Investigación y hashes](./ACCOUNT_PASSWORD_LEGACY_INVESTIGATION.md). | No es E2E ni GO de una función nueva. No identifica el APK firmado por Play, no generaliza a otras versiones ni reabre ACCOUNT-DETAILS/ACCOUNT-RECOVERY-SECRET. | S08,S10,S13,S14 · [fuente](https://github.com/dossijeo/quata/blob/f0fd50ca65ca35372093c127fb09e379743274ff/app/src/main/java/com/quata/feature/profile/data/ProfileRepositoryImpl.kt) |
