...
2. Integrar `SCR-OFFICIAL-EDITOR` tras el GO local del candidato PR #217 `618963b12eea9916c6cf681653a6e2db1e4edce1`:
   Android, Web/Wasm, iOS, postflight RLS y comparativa final pasan sobre el mismo SHA con lectura exacta autenticada Web/iOS y sin falsos positivos.
