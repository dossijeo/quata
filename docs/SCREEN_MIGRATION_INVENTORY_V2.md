...
|---|---|---|---|---|---|
| `ACCOUNT-DETAILS` | VERIFIED_ANDROID · aceptación pendiente | Cuenta → Mis datos | Nombre, barrio, prefijo/teléfono, carga, validación, guardado, error y recarga. Aceptación: Modificar datos de prueba desde UI, verificar lectura tras recarga, restaurar snapshot y probar fallo parcial. | La existencia de campos no certifica persistencia de todos ellos; no ejecutar sobre una cuenta real sin opt-in. | S08,S13,S14 · [fuente](https://github.com/dossijeo/quata/blob/bd8a73b03b1139024f9e0447b0d452f156267578/app/src/main/java/com/quata/feature/profile/presentation/ProfileScreen.kt) |
