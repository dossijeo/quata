...
Revocación y renovación frías, y mensaje ausente, conservan producto `3bcfec15`,
...
| Chat, metadato local de sesión vencido | Renovado en 3bcfec15 con runner e57f0b36: un refresh real, recibo verificado y mensaje exacto visible | GO local renovado en 5676e3a3/b2bc9454: metadato vencido inmediatamente antes de entregar, mismo documento, cero refresh previos y uno verificado posterior | Vuelta y recarga sin reapertura ni segundo refresh; limpieza completa | Recarga caliente acreditada por estado, sin captura propia; no JWT realmente vencido ni sesión revocada; preservado el primer ensayo fallido |
