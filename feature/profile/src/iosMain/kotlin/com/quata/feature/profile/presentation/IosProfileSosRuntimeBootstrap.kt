...
internal val IosEmergencyContactsEditorStrings = EmergencyContactsEditorStrings(
    ...
    requestContactsPermission = "Allow contacts access",
    contactPickerUnavailable = "Contact import is not available on this platform yet. Use QUATA contacts below.",
    contactPickerCancelled = "Contact import cancelled.",
    contactPickerFailed = "Could not import contacts.",
    contactsPicked = { count -> "$count contacts selected. Match them with QUATA users before saving." },
    contactsPermissionGranted = "Contacts access granted.",
    contactsPermissionDenied = "Contacts access denied.",
    contactsPermissionPermanentlyDenied = "Contacts access is blocked in system settings.",
    contactsPermissionUnavailable = "Contacts access is not available on this platform.",
