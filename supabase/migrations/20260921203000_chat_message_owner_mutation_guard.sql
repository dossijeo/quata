-- Keep message edit/delete ownership aligned with the common Chat action bar.
-- Thread owners and moderators manage membership; they do not impersonate a
-- message author or remove that author's message through these user RPCs.
