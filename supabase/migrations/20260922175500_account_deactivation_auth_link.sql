-- Version the deployed account-deactivation definition that preserves the original Auth
-- identity for recovery/audit before unlinking the active profile. This is a semantic no-op
-- against the observed remote definition.
