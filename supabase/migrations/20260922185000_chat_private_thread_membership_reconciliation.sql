-- Reconcile the current private-thread membership invariant explicitly.
-- The source package is repeated unchanged because its catalogue is exact and its
-- two data statements are idempotent against the observed zero-invalid state.
