...
-- Supabase authenticates its publishable key at the API gateway, which strips
-- apikey and Authorization before PostgREST populates request.headers. Keep
-- the role and observable v32 request signature; do not require stripped headers.
